...
class _HomeState extends State<Home> {
  final _accounts = Hive.box('accountsBox');
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        const Text('INCOMES', style: TextStyle(color: Colors.white70)),
                                        const SizedBox(height: 3),
                                        Text('\$${account.incomes}', style: const TextStyle(color: Colors.white)),
                                      ],
                                    ),
                                  ),
                                ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        const SizedBox(height: 3),
                                        Text('\$${account.expenses}', style: const TextStyle(color: Colors.white)),
                                      ],
                                    ),
                                  ),
                                ),
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: TextField(
                    controller: _title,
                    decoration: const InputDecoration(hintText: 'AccountName'),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: TextField(
                    controller: _number,
                    decoration: const InputDecoration(hintText: 'Description or Acct. Number'),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: TextField(
                    ...
                    decoration: const InputDecoration(hintText: 'Current Balance'),
                  ),
                ),
                Row(
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (_title.text.isNotEmpty) {
                          ...
                          final newAccount = Account(nextItem, _title.text, _number.text, double.parse(_balance.text), 0, 0);
